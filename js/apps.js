...
const sttaddr = "0xe46c1cea21efa38376ed24196f49a5c6eb2d9a10";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0xe46c1cea21efa38376ed24196f49a5c6eb2d9a10";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://minesofdalarnia.finance?ref=' + document.getElementById('refaddress').value;
        }
    }
}
